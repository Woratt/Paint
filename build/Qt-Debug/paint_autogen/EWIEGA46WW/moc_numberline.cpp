/****************************************************************************
** Meta object code from reading C++ file 'numberline.h'
**
...
#error "The header file 'numberline.h' doesn't include <QObject>."
...
{
    auto *_t = static_cast<numberLine *>(_o);
    (void)_t;
    (void)_c;
    (void)_id;
    (void)_a;
...
const QMetaObject *numberLine::metaObject() const
{
...
int numberLine::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
