...
template <> constexpr inline auto createFileWindow::qt_create_metaobjectdata<qt_meta_tag_ZN16createFileWindowE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<createFileWindow, qt_meta_tag_ZN16createFileWindowE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject createFileWindow::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16createFileWindowE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN16createFileWindowE_t>.metaTypes,
    nullptr
} };
